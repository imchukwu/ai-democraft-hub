      ...
      <div className="border-b border-border bg-slate-950 py-16 text-slate-100 md:py-20 text-center">
        <div className="container-forum">
          ...
          <p className="mt-3 text-sm text-slate-300 max-w-2xl mx-auto">
            Apply for dedicated exhibition space, technology demonstration slots, and directory listing at Congress Hall, Transcorp Hilton, Abuja (14th – 16th October 2026).
          </p>
